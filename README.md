...
## Notes
This Proof of Concept (PoC) is intended only for legitimate security testing and educational purposes. Using this script on systems without clear permission from the owner is prohibited and may be illegal. The author is not responsible and cannot be held liable for any misuse, damage, or legal consequences arising from the use of this script. By using this tool, you agree to take full responsibility for your actions.
